...
```{r viz-secret-gapminder-geom-jitter, eval = FALSE}
library(ggplot2)
...
```{r viz-secret-summary, eval = FALSE}
gapminder %>%
  ## 데이터프레임 데이터 조작: `dplyr`
  filter(country == "Korea, Rep.") %>%
