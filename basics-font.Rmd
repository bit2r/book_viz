...
```{r font-extrafont-in-r, eval=FALSE}
library(extrafont)
...
```{r ggplot-extrafont-in-r, warning=FALSE}
library(tidyverse)
library(extrafont)
...
```{r showtext-font-setup, eval=FALSE, warning=FALSE}
# 0. 환경설정 --------------------------------------------------------------------------
library(tidyverse)
...
```{r font-showtext-showtext-ggplot, warning=FALSE, eval = FALSE}
library(tidyverse)
library(showtext)
...
```{r showtext-showtext-korean, warning=FALSE, eval = FALSE}
# ３. 한글 그래픽 --------------------------------------------------------------------------
## 나눔펜　스크립트
